...
class ExternalMonitor extends BaseMonitor
{
	...
	*********************/
	public function addExternalMonitor($name, $tag, $locationIds, $url, $type, $interval, $contentMatchString, $detailedTestType, $contentMatchFlag, $postData, $testParams, $timeout, $overSSL = 0,$AuthToken,$validation='')
	{
