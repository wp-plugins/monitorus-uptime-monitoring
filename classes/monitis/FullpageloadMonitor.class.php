...
class FullpageloadMonitor extends BaseMonitor
{
  ...
  /*********************
	...
	*********************/
    ...
    //custom
    public function getFullPageSnapshot($output='')
    {
        $params["output"] = $output;
        $resp = parent::makeGetRequest("topFullpage", $params);
        return $resp;
    }

    public function getFullPageResults($monitorId, $output)
    {
        $params["monitorId"] = $monitorId;
        $params["output"] = $output;
        $resp = parent::makeGetRequest("fullPageLoadTestResult", $params);
        return $resp;
    }
    //end custom
}
